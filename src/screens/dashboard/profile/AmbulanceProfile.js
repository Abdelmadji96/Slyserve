...
const AmbulanceProfile = ({navigation, application, user, role, token}) => {
      ...
      <Animated.View
        ...
        <View style={styles.header}>
          ...
          <Feather
            ...
            size={30}
            color={COLORS.PRIMARY12}
            onPress={() => navigation.navigate('AmbulanceEditProfile')}
          />
        </View>
        <ScrollView
          ...
          <View
            ...
            <Text style={styles.headerTitle}>
              {application.language.data.NAME}
            </Text>
            <Text>{user?.nom}</Text>
          </View> */}
          <Text />
...
export default connect(mapStateProps, null)(AmbulanceProfile);
