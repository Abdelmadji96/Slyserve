...
const choiceItemHeight = HEIGHT / 11.5;
const choiceItemWidth = WIDTH * 0.8;
const iconSize = 30;

const ProfessionalLoginChoice = ({navigation, application}) => {
      ...
      <Animated.View
        ...
        <View style={styles.subContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('Login', {choice: USER_ROLES.DOCTOR})
            }>
            <FontAwesome5
              name="stethoscope"
              size={iconSize}
          ...
          <TouchableOpacity
            style={styles.choiceItemContainer}
            onPress={() =>
              navigation.navigate('Login', {choice: USER_ROLES.PARAMEDICAL})
            }>
            <FontAwesome5
          ...
          <TouchableOpacity
            style={styles.choiceItemContainer}
            onPress={() =>
              navigation.navigate('Login', {choice: USER_ROLES.CLINIC_HOSPITAL})
            }>
            <FontAwesome5
              name="hospital"
              size={iconSize}
          ...
          <TouchableOpacity
            style={styles.choiceItemContainer}
            onPress={() =>
              navigation.navigate('Login', {choice: USER_ROLES.LABORATORY})
            }>
            <Fontisto
              name="test-tube"
              size={iconSize}
          ...
          <TouchableOpacity
            style={styles.choiceItemContainer}
            onPress={() =>
              navigation.navigate('Login', {choice: USER_ROLES.PHARMACY})
            }>
            <Fontisto
              name="drug-pack"
              size={iconSize}
          ...
          <TouchableOpacity
            style={styles.choiceItemContainer}
            onPress={() =>
              navigation.navigate('Login', {choice: USER_ROLES.AMBULANCE})
            }>
            <FontAwesome5
              name="ambulance"
              size={iconSize}
          ...
          <TouchableOpacity
            style={styles.choiceItemContainer}
            onPress={() =>
              navigation.navigate('Login', {choice: USER_ROLES.BLOOD_DONOR})
            }>
            <Fontisto
              name="blood-drop"
              size={iconSize}
