...
const RegisterChoice = ({navigation, application}) => {
      ...
      <Animated.View
        ...
        <View style={styles.subcontainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate('Register', {choice: 'PATIENT'})
            }>
            <Feather
              name="user"
              size={iconSize}
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('ProfessionalRegisterChoice')}>
            <FontAwesome5
...
export default connect(mapStateProps, null)(RegisterChoice);
