...
const LaboratoryProfile = ({navigation, application, user, role, token}) => {
      ...
      <Animated.View
        ...
        <View style={styles.header}>
          ...
          <Feather
            ...
            size={30}
            color={COLORS.PRIMARY12}
            onPress={() => navigation.navigate('ClinicEditProfile')}
          />
        </View>
        <ScrollView
...
export default connect(mapStateProps, null)(LaboratoryProfile);
