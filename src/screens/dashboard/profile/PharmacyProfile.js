...
const PharmacyProfile = ({navigation, application, user, role, token}) => {
      ...
      <Animated.View
        ...
        <View style={styles.header}>
          ...
          <Feather
            ...
            size={30}
            color={COLORS.PRIMARY12}
            onPress={() => navigation.navigate('PharmacyEditProfile')}
          />
        </View>
        <ScrollView
...
export default connect(mapStateProps, null)(PharmacyProfile);
